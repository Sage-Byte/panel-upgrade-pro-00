      ...
      <div className="container px-4 py-12 sm:py-16 md:py-20">
        <div className="max-w-3xl mx-auto text-center">
          <h2 id="cta-title" className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">
            Don't Miss Out on Professional EV Charger Installation
          </h2>
          <p className="mt-3 text-base sm:text-lg md:text-xl/8 opacity-90">
            Our quick assessment helps you get the right EV charging solution. Start now and get your custom quote.
          </p>

          <div className="mt-8 flex justify-center">
            {onCTAClick ? (
              <Button size="lg" variant="hero" onClick={onCTAClick} className="px-6">
                Get My EV Charger Quote <ArrowRight className="ml-1" />
              </Button>
            ) : (
              <Button asChild size="lg" variant="hero" className="px-6">
                <Link to="/quiz">Get My EV Charger Quote <ArrowRight className="ml-1" /></Link>
              </Button>
            )}
          </div>

          <p className="mt-4 text-sm/6 opacity-80">Join 1,500+ homeowners who chose professional EV charger installation</p>

          <ul className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm/6 opacity-90">
            <li className="flex items-center justify-center gap-2"><Sun className="size-4" /> EV Experts</li>
            ...
            <li className="flex items-center justify-center gap-2"><CheckCircle2 className="size-4" /> 1,500+ Installs</li>
          </ul>
        </div>
      </div>
    </section>
